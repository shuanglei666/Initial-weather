      ...
      <div class="one">
        <div class="left">
          <div class="lft_top">
            ...
            <div>
              <el-input v-model="iptFrom" placeholder="请输入出发"></el-input>
            </div>
          </div>
          <div class="lft_bottom">
            ...
            <div>
              <!-- 米 -->
              <el-input v-model="iptTo" placeholder="请输入到达"></el-input>
            </div>
          </div>
        </div>
        <div class="right">
...
export default {
  ...
  computed: {
    ...
    lastName() {
      return this.value2.substr(3, this.value2.length);
    },
  },
  mounted() {
    this.getSelect();
    ...
    getRata() {
      ...
      rata({
        ...
        .then((res) => {
          ...
          //   this.iptTo = this.iptFrom * this.result
          // } else if (this.jump == 2) {
          //   this.result = res.data[1].result
          //   this.iptFrom = this.iptTo * this.result
          // }
          if (this.jump == 1) {
            this.result = res.data[0].result;
...
第二种:给select添加 @change='change($event)' 注意:change后面带括号!!!,并且要事件传参$event      methods下面方法传事件e可以的到对应值
