      ...
      <div class="one">
        <div class="left">
          <div class="lft_top">
            ...
            <div>
              <!-- 特别注意@focus="focus1"加再input里面而不是option触发input获取焦点 -->
              <el-input
                @focus="focus1"
                v-model="iptFrom"
                placeholder="请输入出发"
...
export default {
  data() {
    return {
      key: "11", //00d26ea86b5426af9d20323597a5f231
      value1: "", //出发
      value2: "", //目的
      options: [], //下拉列表
      result: [], //  获得汇率
  ...
  methods: {
    focus1() {
      console.log("第一个输入框1111111");

      this.jump = 1;
    },
    focus2() {
      console.log("第二个输入框2222222");
      this.jump = 2;
    },
    // Selection列表
    getSelect() {
    ...
    getRata() {
      ...
      rata({
        ...
        .then((res) => {
          console.log(res.data, "data11111111");
          if (this.jump == 1) {
